    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imdb_rating', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
                ('imdb_votes', models.CharField(blank=True, max_length=64, null=True)),
                ('imdb_id', models.CharField(blank=True, max_length=64, null=True)),
                ('type', models.CharField(blank=True, max_length=64, null=True)),
                ('dvd', models.CharField(blank=True, max_length=64, null=True)),
                ('box_office', models.CharField(blank=True, max_length=64, null=True)),
                ('production', models.CharField(blank=True, max_length=64, null=True)),
